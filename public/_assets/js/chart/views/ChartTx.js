      ...
      this.$el.off();
		...
		searchAcu: function(e) {
			...
			if (e.keyCode == 13 || e.keyCode == undefined) {	//!!!for blur event : e.keyCode == undefined
				...
				e.stopPropagation();
				this.updSrhAcus(e);
        console.log('searchAcu', e.keyCode);
			}
